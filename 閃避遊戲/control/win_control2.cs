...
namespace 閃避遊戲
{
    public partial class win_control2 : UserControl
    {
        ...
        private void win_control_Load(object sender, EventArgs e)
        {
            for (int i = 0; i <= 13; i++)
            {
            ...
            for (int i = 0; i <= 42; i++)
            {
                image1 = new Bitmap("pic\\win\\腦\\" + i + ".png");
                images1.Add(image1);
            }
        ...
        private void win_control_Paint(object sender, PaintEventArgs e)
        {
        ...
        public void draw_img1(Graphics g)//畫物件
        {
            ...
            else if (ok == 2)
            {
                ...
                switch (a1)
                {
                    case 1: image1 = images1[41]; break;
                    case 6: image1 = images1[42]; a1 = -1; a += 1; break;
                }
                //if (a == 7)
                //{
                //    ok = 3;
