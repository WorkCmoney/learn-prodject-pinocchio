...
{
    public partial class win_control1 : UserControl
    {
        ...
        public win_control1()
        {
            ...
            x1 = 400; y1 = 230; width1 = 180; height1 = 267;
        }
        ...
        private void win_control1_Load(object sender, EventArgs e)
        {
            for (int i = 0; i <= 13; i++)
            {
            ...
            for (int i = 0; i <= 41; i++)
            {
                image1 = new Bitmap("pic\\win\\眼\\" + i + ".png");
                images1.Add(image1);
            }
            image = images[0];
            image1 = images1[0];
        }
        private void win_control1_Paint(object sender, PaintEventArgs e)
        {
        ...
        public void draw_img1(Graphics g)//畫物件
        {
            ...
            else if (ok == 2)
            {
                ...
                switch (a1)
                {
                    case 1: image1 = images1[40]; break;
                    case 6: image1 = images1[41]; a1 = -1; a += 1; break;
                }
                //if (a == 7)
                //{
                //    ok = 3;
